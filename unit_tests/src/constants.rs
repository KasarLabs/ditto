...
/**
 * Contract address for largest ETH holder as of time of development
 * 
 * Details concerning this specific contract can be found on StarkScan:
 * https://starkscan.co/contract/0x03a20d4f7b4229e7c4863dab158b4d076d7f454b893d90a62011882dc4caca2a
 */
